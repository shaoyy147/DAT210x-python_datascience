...
X_train, X_test, y_train, y_test = load(r'E:\Python_SYY\edx\DAT210x\Module6\Datasets\optdigits.tes', r'E:\Python_SYY\edx\DAT210x\Module6\Datasets\optdigits.tra')
...
#
# .. your code here ..
plt.imshow(X_test.ix[999,:].reshape(1,-1))
plt.show
